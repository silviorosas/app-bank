package com.banking.appbank.utils;
...
public class AccountUtils {
    ...
    public static final String ACCOUNT_EXISTS_MESSAGE="The user is already registered";
    ...
    //generar num random entre min y max
    int randomNumber= (int) Math.floor(Math.random() * (max - min + 1) + min);

    //convertir current y randomNumber a cadena
